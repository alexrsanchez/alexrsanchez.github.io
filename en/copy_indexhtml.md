...
<nav class="navbar navbar-light fixed-top navbar-expand-lg py-0" id="navbar-main">
  <div class="container">
      ...
      <a class="navbar-brand" href="/en"><div style="position:relative;float:left">Alejandro Rodríguez Sánchez<img src="/img/portrait.jpg" alt="Alejandro Rodríguez Sánchez" style="float: left;"></div></a>
    ...
    <div class="collapse navbar-collapse" id="navbar">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/en/#publications_selected" data-target="#publications_selected">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/en/#graphs" data-target="#graphs">
