  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbar">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/es/#posts" data-target="#posts">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/es/#publications_selected" data-target="#publications_selected">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/es/#graphs" data-target="#graphs">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/es/#about" data-target="#about">
